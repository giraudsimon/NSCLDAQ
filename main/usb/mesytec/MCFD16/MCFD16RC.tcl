...
snit::type MCFD16RC {
  ...
  constructor {proxy} {
      ...
      puts  [format %x [$_proxy Read 254]]
      puts  [format %x [$_proxy Read 255]]
  }
  ...
  method GetTriggerSource {trigId} {
    ...
    set sourceNameMap [dict create 0 ""  1 or 2 multiplicity 4 pair_coinc 8 \
