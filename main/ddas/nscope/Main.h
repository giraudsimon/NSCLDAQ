...
static Commands SetupMenuCommands[] =
{
    ASG,
	BASELINE,
	EFILTER,
...
static Commands ExpertMenuCommands[] = {
    MODVAR,
    MODCSRB,
    TRIGCONFIG0,
    FINDTAU,
...
static Commands ScopeMenuCommands[] =  {
    MAXMIN,
    SCOPEDT
};
...
//  ExtTrig *exttrig;
  ...
  int  FindTau (unsigned short ModNum, unsigned short ChanNum, 
   ...
   void disableSetupMenu();
   void enableSetupMenu();
   void disableExpertMenu();
   void enableExpertMenu();
   void disableScopeMenu();
   void enableScopeMenu();
   void disableButtons();
   void enableButtons();
