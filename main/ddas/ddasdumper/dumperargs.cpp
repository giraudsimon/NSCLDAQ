/*
  ...
  /usr/bin/gengetopt --input=../../ddasdumper/dumperargs.ggo --file-name dumperargs --output-dir=../../ddasdumper 
...
const char *gengetopt_args_info_usage = "Usage: ddasdumper [OPTIONS]...";
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->format_arg = format_arg_v11;
      ...
      switch (c)
        ...
        case 'F':	/* Format of input data - replaces the legacy-mode flag.  */
          ...
          if (update_arg( (void *)&(args_info->format_arg), 
              ...
              &(local_args_info.format_given), optarg, cmdline_parser_format_values, "v11", ARG_ENUM,
              check_ambiguity, override, 0, 0,
              "format", 'F',
              additional_error))
            goto failure;
